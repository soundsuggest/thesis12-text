...
\include{tex/chapter_foreword}
\include{tex/chapter_summary}
\include{tex/chapter_samenvatting}

\newpage
%% List of acronyms
%% ----------------
%\printnomenclature
%\include{tex/chapter_abbreviations}
...
\include{tex/chapter_literature_study}
\include{tex/chapter_requirements}
% Resultaten en bespreking van het onderzoek.
\include{tex/chapter_prototype}
\include{tex/chapter_implementation}
...
\include{tex/chapter_conclusion}
...
\input{tex/appendix_usecases}

% Questions for the user tests for each iteration
\input{tex/appendix_tasklists}

% The statistics of the social media usage
\input{tex/appendix_quantifiedself}
